...
Declaración de adopción AOS para `anclora-linguo-cam`.

## Metadatos

- Repository Name: anclora-linguo-cam
...
`anclora-linguo-cam` forma parte del ecosistema Anclora como aplicación operativa Vite + React.
